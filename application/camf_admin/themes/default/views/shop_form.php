...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span9" id="content">
            ...
            <?php endif; ?>
            <?php echo form_open_multipart('shops/form/' . $id); ?>
                            ...
                            <div class="row">
                                <div class="span12">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        {
                                                $.post("<?php echo site_url('categories/category_autocomplete/'); ?>", { name: $('#category_search').val(), limit:10},
                                                        function(data) {                                                                
                                                                $('#category_list').html('');
                        ...
                        <div class="span3" style="text-align:center">
                            ...
                            <div class="row">
                                <div class="span12">
                                    ...
                                    {
                                            $.post("<?php echo site_url('shops/shop_autocomplete/'); ?>", { name: $('#shop_search').val(), limit:10},
                                                    function(data) {
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary"><?php echo lang('form_save'); ?></button> <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo site_url("shops")?>'"><?php echo lang('form_cancel'); ?></button>
            </div>
            </form>
