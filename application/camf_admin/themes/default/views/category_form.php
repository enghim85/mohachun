        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                    ...
                    <?php endif; ?>
                    <?php echo form_open_multipart('categories/form/' . $id); ?>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary"><?php echo lang('form_save'); ?></button> <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo site_url("categories")?>'"><?php echo lang('form_cancel'); ?></button>
                    </div>
                    </form>
